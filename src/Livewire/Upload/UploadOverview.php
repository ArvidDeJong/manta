        ...
        if ($this->model_class) {
            ...
            foreach ($items as $upload) {
                $thumbnails[] = [
                    ...
                    'url_update' => route('upload.update', ['upload' => $upload, 'redirect_url' => $this->redirect_url, 'redirect_title' => $upload->title]),
                    'url_crop' => route('upload.crop', ['upload' => $upload, 'redirect_url' => $this->redirect_url, 'redirect_title' => $upload->title]),
                ];
            }
